...
class TestAdaptiveParser:
    ...
    def test_parse_summary_entry(self):
        ...
        entry = {"type": "summary", "summary": "Test session summary", "leafUuid": "uuid-123"}
    ...
    def test_field_discovery(self):
        ...
        obj = {"timestamp": "2025-01-01", "cwd": "/home/user", "gitBranch": "main"}
    ...
    def test_tool_result_extraction(self):
        ...
        entry = {"type": "user", "toolUseResult": "File read successfully"}
        ...
        entry2 = {"type": "user", "tool_result": "Command executed"}

        result2 = parser.parse_entry(entry2)
        # Should find it through field aliases
        assert (
            result2["toolUseResult"] == "Command executed"
            or result2.get("_unknown_tool_result") == "Command executed"
        )
